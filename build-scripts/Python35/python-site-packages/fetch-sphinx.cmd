...
@call %PYTHON35_INSTALL_ROOT%\Scripts\pip.cmd install Babel==%BABEL_VERSION%
@set SPHINX_VERSION=1.3.1
@call %PYTHON35_INSTALL_ROOT%\Scripts\pip.cmd install Sphinx==%SPHINX_VERSION%
@call %PYTHON35_INSTALL_ROOT%\Scripts\pip.cmd install sphinx_bootstrap_theme
