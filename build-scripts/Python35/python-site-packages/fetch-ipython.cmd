...
@set VERSION=2.4.1
@call %PYTHON35_INSTALL_ROOT%\python.exe -m pip install IPython[notebook]==%VERSION%
...
%PYTHON35_INSTALL_ROOT%\python.exe %WRITE_LAUNCHER% --rm_exe %PYTHON_SITE_PACKAGES%\ipython-%VERSION%.dist-info\entry_points.txt
