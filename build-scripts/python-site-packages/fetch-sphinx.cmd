...
@call %PYTHON_INSTALL_ROOT%\Scripts\pip.cmd install Babel==%BABEL_VERSION%
@set SPHINX_VERSION=1.3.1
@call %PYTHON_INSTALL_ROOT%\Scripts\pip.cmd install Sphinx==%SPHINX_VERSION%
@call %PYTHON_INSTALL_ROOT%\Scripts\pip.cmd install sphinx_bootstrap_theme
...
@call %PYTHON_INSTALL_ROOT%\python.exe %WRITE_LAUNCHER% --rm_exe %PYTHON_SITE_PACKAGES%\sphinx-%SPHINX_VERSION%.dist-info\entry_points.txt
@call %PYTHON_INSTALL_ROOT%\python.exe %WRITE_LAUNCHER% --rm_exe %PYTHON_SITE_PACKAGES%\Babel-%BABEL_VERSION%.dist-info\entry_points.txt
