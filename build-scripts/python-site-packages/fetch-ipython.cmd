...
@set VERSION=3.2.3
@call %PYTHON_INSTALL_PREFIX%\Scripts\pip.cmd install IPython[notebook]==%VERSION%
...
%PYTHON_INSTALL_PREFIX%\python.exe %WRITE_LAUNCHER% --rm_exe %PYTHON_SITE_PACKAGES%\ipython-%VERSION%.dist-info\entry_points.txt
