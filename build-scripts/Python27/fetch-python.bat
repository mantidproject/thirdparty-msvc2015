...
if not exist %PYTHON27_INSTALL_ROOT% (
  @echo Extracting Python bundle to %PYTHON27_INSTALL_ROOT%
  msiexec /a %BUILD_DIR%\%SRC_PKG% /q TARGETDIR=%PYTHON27_INSTALL_ROOT%
  :: delete the msi that is also extracted
  del /Q %PYTHON27_INSTALL_ROOT%\%SRC_PKG%
)
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
set PYTHON_SCRIPTS_DIR=%PYTHON27_INSTALL_ROOT%\Scripts
set PYTHON_EXE=%PYTHON27_INSTALL_ROOT%\python.exe
@echo Installing pip
if not exist %PYTHON27_INSTALL_ROOT%\Lib\site-packages\pip (
...
set PYTHON_SITE_PACKAGES=%PYTHON27_INSTALL_ROOT%\Lib\site-packages
