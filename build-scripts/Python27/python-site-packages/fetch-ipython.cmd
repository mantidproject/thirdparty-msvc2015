...
@set VERSION=2.4.1
@call %PYTHON_INSTALL_ROOT%\Scripts\pip.cmd install IPython[notebook]==%VERSION%
...
%PYTHON_INSTALL_ROOT%\python.exe %WRITE_LAUNCHER% --rm_exe %PYTHON_SITE_PACKAGES%\ipython-%VERSION%.dist-info\entry_points.txt
