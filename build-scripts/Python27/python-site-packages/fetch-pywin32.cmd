...
@set SRC_PKG_URL="http://downloads.sourceforge.net/project/pywin32/pywin32/Build%%%%20219/pywin32-219.win-amd64-py2.7.exe"
@set SRC_PKG=pywin32-219.win-amd64-py2.7.exe
...
@if not exist %SRC_ROOT% call 7z x %SRC_PKG% -o%SRC_ROOT% -y
