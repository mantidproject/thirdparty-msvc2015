...
::Fetch Boost 1.65.1
@set SRC_PKG_URL="https://sourceforge.net/projects/boost/files/boost/1.65.1/boost_1_65_1.zip"
@set SRC_PKG=boost_1_65_1.zip
...
set BOOST_ROOT=%BUILD_DIR%\boost_1_65_1
