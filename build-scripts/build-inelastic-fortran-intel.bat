...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@set PATH=C:\Perl64\bin;C:\Program Files (x86)\CMake\bin;C:\Program Files (x86)\Git\bin;C:\Program Files\7-Zip;%~dp0\cmds;%PATH%
...
set modname=%1
set routine=%2
%PYTHON_EXE% %F2PY_SCRIPT% --verbose -c --fcompiler=intelvem --compiler=msvc ^
  -m %modname% %3 %4 %5 %6 %7 %8 %9 only: %routine% :
endlocal
goto:eof
