...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --assume-shared --qsci-api -w --no-designer-plugin',
    'pyqt_mod_dir':      'D:\\GitHub\\thirdparty-msvc2015\\lib\\python2.7\\Lib\\site-packages\\PyQt4',
    ...
    'qt_archdata_dir':   'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4',
    'qt_data_dir':       'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4',
    'qt_dir':            'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4\\include',
    'qt_lib_dir':        'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4\\include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4\\lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'd:\\GitHub\\thirdparty-msvc2015\\lib\\qt4\\bin\\\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
