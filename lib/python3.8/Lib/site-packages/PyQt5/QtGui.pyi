...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def convertToFormat(self, format: 'QImage.Format', colorTable: typing.Iterable[int], flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...) -> 'QImage': ...
