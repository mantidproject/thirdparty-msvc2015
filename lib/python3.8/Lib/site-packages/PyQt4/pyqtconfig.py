...
_pkg_config = {
    'pyqt_bin_dir':      sys.prefix,
    'pyqt_config_args':  '--confirm-license --no-qsci-api --no-designer-plugin',
    'pyqt_mod_dir':      os.path.join(sys.prefix, 'Lib\\site-packages\\PyQt4'),
    ...
    'qt_archdata_dir':   os.path.join(sys.prefix, '..', 'qt4'),
    'qt_data_dir':       os.path.join(sys.prefix, '..', 'qt4'),
    'qt_dir':            os.path.join(sys.prefix, '..', 'qt4'),
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        os.path.join(sys.prefix, '..', 'qt4', 'include'),
    'qt_lib_dir':        os.path.join(sys.prefix, '..', 'qt4', 'lib'),
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                os.path.join(sys.prefix, '..', 'qt4', 'include'),
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                os.path.join(sys.prefix, '..', 'qt4', 'lib'),
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      os.path.join(sys.prefix, '..', 'qt4', 'bin\\\\moc.exe'),
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
