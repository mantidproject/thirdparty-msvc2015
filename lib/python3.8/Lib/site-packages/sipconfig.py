...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    sys.prefix,
    'default_mod_dir':    os.path.join(sys.prefix, 'Lib\\site-packages'),
    'default_sip_dir':    os.path.join(sys.prefix, 'sip'),
    'deployment_target':  '',
    'platform':           'win32-msvc2015',
    'py_conf_inc_dir':    os.path.join(sys.prefix, 'include'),
    'py_inc_dir':         os.path.join(sys.prefix, 'include'),
    'py_lib_dir':         os.path.join(sys.prefix, 'libs'),
    'py_version':         0x030800,
    'qt_framework':       0,
    'sip_bin':            os.path.join(sys.prefix, 'sip'),
    'sip_config_args':    '--platform=win32-msvc2015 --sip-module PyQt5.sip',
    'sip_inc_dir':        os.path.join(sys.prefix, 'include'),
    'sip_module_dir':     os.path.join(sys.prefix, 'Lib\\site-packages'),
    'sip_root_dir':       os.path.join(sys.prefix, 'Lib\\site-packages'),
